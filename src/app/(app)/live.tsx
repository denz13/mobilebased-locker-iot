...
const ESP_CAM_STREAM_URL = "http://192.168.8.50/";
        ...
        >
          ...
          <View style={styles.cameraCard}>
            <View style={styles.cameraTopRow}>
              ...
              <View
                style={[
                  styles.pill,
                  espOnline ? styles.pillLive : styles.pillOffline,
                ]}
              >
                <View
                  style={[
                    styles.pillDot,
                    espOnline ? styles.pillDotLive : styles.pillDotOffline,
                  ]}
                />
                <Text style={styles.pillText}>
                  {espOnline ? "LIVE" : "OFFLINE"}
                </Text>
              </View>
            </View>
            ...
            <View
              style={[
                styles.videoFrame,
                !espOnline && styles.videoFrameOffline,
              ]}
            >
              <View style={styles.videoOverlayTop}>
                <View
                  style={[
                    styles.overlayChip,
                    !espOnline && styles.overlayChipWarn,
                  ]}
                >
                ...
                >
                  ...
                  />
                  <Text style={styles.overlayChipText}>
                    {espOnline ? "ESP stream" : "Not connected"}
                  </Text>
                </View>
              </View>
              ...
              {!espOnline ? (
                <View style={styles.videoCenter}>
                  ...
                  <Text style={styles.videoCenterSub}>
                    The camera is offline or unreachable. Check power, Wi-Fi,
                    and make sure {ESP_CAM_STREAM_URL} is accessible from this
                    phone.
                  </Text>
                </View>
              ) : null}
            ...
            {!espOnline ? (
              <View style={styles.offlineBanner}>
                ...
                <Text style={styles.offlineBannerText}>
                  Cannot reach {ESP_CAM_STREAM_URL}. Keep your phone and
                  ESP32-CAM on the same network.
                </Text>
              </View>
            ) : null}
          ...
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoBody}>
              This page shows your current ESP32-CAM feed in real time. Use
              Refresh if the network gets slow or the frame stalls.
            </Text>
          </View>
          ...
          <View style={styles.tipsCard}>
            ...
            <View style={styles.tipItem}>
              ...
              <Text style={styles.tipText}>
                Keep the phone and ESP32-CAM on the same Wi‑Fi network.
              </Text>
            </View>
            <View style={styles.tipItem}>
              <MaterialCommunityIcons
              ...
              />
              <Text style={styles.tipText}>
                Good lighting improves motion detection and video quality.
              </Text>
            </View>
          </View>
        </ScrollView>
